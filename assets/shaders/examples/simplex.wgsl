...
fn fragment(
    ...
    if material.dimension == 2 {
        let r = noise_simplex_vec2f(vec2(i.x + material.time, i.y));
        return vec4(r, r, r, 1.0);
    } else if material.dimension == 3 {
        let r = noise_simplex_vec3f(vec3(i.x + material.time, i.y, i.z));
        return vec4(r, r, r, 1.0);
    } else if material.dimension == 4 {
        let r = noise_simplex_vec4f(vec4(material.time, i.x, i.y, i.z));
        return vec4(r, r, r, 1.0);
    } else {
        return vec4(1.0);
    }
